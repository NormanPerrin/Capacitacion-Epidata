...
public class ClienteInitTest {
	...
	private Cuenta[] cuentas = new Cuenta[]{cuenta0, cuenta1, cuenta2};
	...
	public void testCuenta() {
		assertArrayEquals(new Cuenta[]{cuenta1}, cliente1.getCuentas());
	}
	
	@Test
	public void testCuentas() {
		assertArrayEquals(cuentas, cliente2.getCuentas());
	}
